...
# plot the Australian employment by 19 Sectors from 2010 to 2022
...
, "96 Private Households Employing Staff and Undifferentiated Goods- and Service- Producing Activities of Households for Own Use"))) %>% 
  ...
  facet_wrap(name ~. , scales = "free_y")+
   labs(y = "Employment",title = "Australian employment by Sub-Sectors",subtitle = "Year from 2010 to 2022") +
  theme(legend.position = "none") 

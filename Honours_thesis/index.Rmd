...
`Matlab version. 2022a` codes are used to generate the estimated coefficients for the proposed Bayesian VAR model. The author would like to thank Benjamin Wong for providing the MATLAB packages.

R `4.1.2 "Bird Hipple"` [@R] and Rstudio `2022.07.1+554 "Spotted Wakerobin"` [@Rstudio] are used for data analysis in this thesis. 

\vspace{12pt}

R package used and their versions in this research include `matrixStats 0.61.0` [@package_matrixStats], `ggplot2 3.3.5` [@package_ggplot2], `zoo 1.8.9` [@zoo], `tidyverse 1.3.1` [@tidyverse], `dplyr 1.0.8` [@dplyr], `stats 4.1.2` [@stats], `readr 2.1.2` [@readr], `pracma 2.3.8` [@pracma], `lubridate 1.8.0` [@lubridate], `fpp3 0.4.0` [@fpp3], `ggpubr 0.4.0`[@ggpubr]. 

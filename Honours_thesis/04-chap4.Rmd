...
In many time series models, the number of lags is selected based on the patterns of the time series (i.e. seasonality, cycle, or trend). Four lags are typically used for quarterly data (see @anderson2020 and @stock2001). However, because of the high-dimensionality and relatively small sample size in my case, I will use one lag of the 84 subsectoral employment growth rate and one lag of the total employment growth rate. 
